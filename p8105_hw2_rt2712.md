...
The precip\_data data set gives the total amount of precipitation per month for 2016 and 2017. In the original data, the units for the precipitation total per month was given in the title. I decided to provide that information directly in the column name for totals, so I renamed that column total\_inches. I thought this was important information to retain to prevent ambiguity. The total amount of precipitation in 2017 was 32.93 inches.
